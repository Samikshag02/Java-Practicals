...
class Employee {
    ...
    public Employee(String firstName, String lastName, double monthlySalary) {
        ...
        setMonthlySalary(monthlySalary); // Ensuring non-negative salary
    }
...
public class EmployeeTest {
    public static void main(String[] args) {
        ...
        Employee emp1 = new Employee("Sakshi", "Jadhav", 5000);
        Employee emp2 = new Employee("Samiksha", "Gaikwad", 7000);
